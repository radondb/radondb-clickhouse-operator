...
关于如何从源头如何部署 RadonDB ClickHouse Operator，以及如何部署一个 docker 镜像并在 `kubernetes` 中使用，请参考[从源头创建 Operator](../operator_build_from_sources.md)。
...
定义了一个单副本 RadonDB ClickHouse 集群。
