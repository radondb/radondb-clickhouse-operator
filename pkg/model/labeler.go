...
// IsCHOPGeneratedZooKeeperObject check whether object is zookeeper generated by an operator. Check is label-based
func IsCHOPGeneratedZooKeeperObject(meta *meta.ObjectMeta) bool {
	if !util.MapHasKeys(meta.Labels, LabelAppName) {
		return false
	}
	return meta.Labels[LabelZooKeeper] == labelZooKeeperValue
}
