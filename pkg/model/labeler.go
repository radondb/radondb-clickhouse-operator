...
import (
	...
	"github.com/TCeason/clickhouse-operator/pkg/apis/clickhouse.qingcloud.com"
...
const (
	// Kubernetes labels
	LabelReadyName                    = clickhouseqingcloudcom.GroupName + "/ready"
	LabelReadyValue                   = "yes"
	LabelAppName                      = clickhouseqingcloudcom.GroupName + "/app"
	LabelAppValue                     = "chop"
	LabelCHOP                         = clickhouseqingcloudcom.GroupName + "/chop"
	LabelNamespace                    = clickhouseqingcloudcom.GroupName + "/namespace"
	LabelCHIName                      = clickhouseqingcloudcom.GroupName + "/chi"
	LabelClusterName                  = clickhouseqingcloudcom.GroupName + "/cluster"
	LabelShardName                    = clickhouseqingcloudcom.GroupName + "/shard"
	LabelShardScopeIndex              = clickhouseqingcloudcom.GroupName + "/shardScopeIndex"
	LabelReplicaName                  = clickhouseqingcloudcom.GroupName + "/replica"
	LabelReplicaScopeIndex            = clickhouseqingcloudcom.GroupName + "/replicaScopeIndex"
	LabelCHIScopeIndex                = clickhouseqingcloudcom.GroupName + "/chiScopeIndex"
	LabelCHIScopeCycleSize            = clickhouseqingcloudcom.GroupName + "/chiScopeCycleSize"
	LabelCHIScopeCycleIndex           = clickhouseqingcloudcom.GroupName + "/chiScopeCycleIndex"
	LabelCHIScopeCycleOffset          = clickhouseqingcloudcom.GroupName + "/chiScopeCycleOffset"
	LabelClusterScopeIndex            = clickhouseqingcloudcom.GroupName + "/clusterScopeIndex"
	LabelClusterScopeCycleSize        = clickhouseqingcloudcom.GroupName + "/clusterScopeCycleSize"
	LabelClusterScopeCycleIndex       = clickhouseqingcloudcom.GroupName + "/clusterScopeCycleIndex"
	LabelClusterScopeCycleOffset      = clickhouseqingcloudcom.GroupName + "/clusterScopeCycleOffset"
	LabelConfigMap                    = clickhouseqingcloudcom.GroupName + "/ConfigMap"
	labelConfigMapValueCHICommon      = "ChiCommon"
	labelConfigMapValueCHICommonUsers = "ChiCommonUsers"
	labelConfigMapValueHost           = "Host"
	LabelService                      = clickhouseqingcloudcom.GroupName + "/Service"
	...
	LabelZookeeperConfigVersion = clickhouseqingcloudcom.GroupName + "/zookeeper-version"
	LabelSettingsConfigVersion  = clickhouseqingcloudcom.GroupName + "/settings-version"
	LabelObjectVersion          = clickhouseqingcloudcom.GroupName + "/object-version"
)
